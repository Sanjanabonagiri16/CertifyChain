        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Secure, verifiable digital certificates for the modern world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/verify" className="text-gray-400 hover:text-blue-400">
                  Verify Certificate
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-gray-400">
                ...
                123 Certification Street, Tech City
              </li>
            </ul>
          </div>
